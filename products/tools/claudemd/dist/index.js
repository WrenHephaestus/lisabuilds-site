...
async function runAndWrite(signals, outputPath) {
    ...
    if (proceed) {
        ...
        console.log("  Tips:");
        console.log('  - The "Do NOT" section is the most impactful part. Add rules as you discover frustrations.');
        console.log("  - Add architecture details as your project grows. Claude works better with context.");
        console.log("  - Review and update CLAUDE.md periodically. It should evolve with your project.\n");
    }
    else {
        console.log("\n  Cancelled. No files written.\n");
    }
}
function printDetection(signals) {
    const items = [];
    ...
    if (signals.hasCI)
        items.push(`CI: ${signals.ciPlatform}`);
